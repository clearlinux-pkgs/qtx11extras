...
Version  : 5.13.1
Release  : 19
URL      : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtx11extras-everywhere-src-5.13.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtx11extras-everywhere-src-5.13.1.tar.xz
...
%prep
%setup -q -n qtx11extras-everywhere-src-5.13.1
...
%install
export SOURCE_DATE_EPOCH=1568391043
rm -rf %{buildroot}
...
/usr/lib64/libQt5X11Extras.so.5.13.1
