...
Version  : 5.12.1
Release  : 14
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtx11extras-everywhere-src-5.12.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtx11extras-everywhere-src-5.12.1.tar.xz
...
%prep
%setup -q -n qtx11extras-everywhere-src-5.12.1
...
%install
export SOURCE_DATE_EPOCH=1549038342
rm -rf %{buildroot}
...
/usr/lib64/libQt5X11Extras.so.5.12.1
