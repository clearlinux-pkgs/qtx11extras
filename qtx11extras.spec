...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtx11extras-everywhere-src-5.12.4.tar.xz
...
%prep
%setup -q -n qtx11extras-everywhere-src-5.12.4
...
%install
export SOURCE_DATE_EPOCH=1561139526
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtx11extras
cp LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtx11extras/LICENSE.FDL
cp LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtx11extras/LICENSE.GPL2
cp LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtx11extras/LICENSE.GPL3
cp LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtx11extras/LICENSE.GPL3-EXCEPT
cp LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtx11extras/LICENSE.LGPL3
%make_install
...
/usr/lib64/libQt5X11Extras.so.5.12
/usr/lib64/libQt5X11Extras.so.5.12.4

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/qtx11extras/LICENSE.FDL
/usr/share/package-licenses/qtx11extras/LICENSE.GPL2
/usr/share/package-licenses/qtx11extras/LICENSE.GPL3
/usr/share/package-licenses/qtx11extras/LICENSE.GPL3-EXCEPT
/usr/share/package-licenses/qtx11extras/LICENSE.LGPL3
