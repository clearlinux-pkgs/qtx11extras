...
Version  : 5.12.3
Release  : 17
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qtx11extras-everywhere-src-5.12.3.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qtx11extras-everywhere-src-5.12.3.tar.xz
...
%prep
%setup -q -n qtx11extras-everywhere-src-5.12.3
...
%install
export SOURCE_DATE_EPOCH=1556914353
rm -rf %{buildroot}
...
/usr/lib64/libQt5X11Extras.so.5.12.3
