...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.0/submodules/qtx11extras-everywhere-src-5.12.0.tar.xz
...
%prep
%setup -q -n qtx11extras-everywhere-src-5.12.0
...
%install
export SOURCE_DATE_EPOCH=1544047256
rm -rf %{buildroot}
...
/usr/lib64/libQt5X11Extras.so.5.12.0
